...
def data_summary_body():
    ...
    st.success(
        ...
        "Lydia Doe has inherited **four houses in Ames, Iowa** from her "
        "great-grandfather. Although she is experienced in the **Belgian** "
        "real estate market, she lacks knowledge about property values in Ames"
        "She wants to accurately price these properties for potential sale and"
        "explore future investment opportunities.\n\n"
        "### Business Requirements\n"
        "**1. Understand Attribute Correlations**\n"
        "- Lydia wants to understand how house features (size, quality, "
        "renovations) influence sale price.\n"
        "- This will be visualized through **data analysis and correlation "
        "plots** to highlight key price drivers.\n\n"
        "**2. Predict House Prices**\n"
        "- A **machine learning model** is trained to predict house prices "
        "based on key features.\n"
        "- The model will provide **sale price estimates** for Lydia’s four "
        "inherited houses.\n"
        "- It can also predict prices for **any house in Ames**, allowing her "
        "to explore potential investments."
    )
