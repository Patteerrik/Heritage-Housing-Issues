...
def hypotheses_validation_body():
    ...
    # Hypothesis 2
    if st.button("Show Hypothesis 2: Higher quality homes have higher sale prices"):
    ...
    # Hypothesis 3
    if st.button("Show Hypothesis 3: Larger garages lead to higher sale prices"):
    ...
    st.success("These findings provide clear insights into the factors that affect property prices in Ames, Iowa, and support data-driven decision-making.")
